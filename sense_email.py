...
sender = 'traffichelmet@gmail.com' # Type your own email ID
senpass = 'spectrum20' # Enter the password associated with the email
receiver = 'syedumaidahmed96@gmail.com' # Receiver's Email ID
